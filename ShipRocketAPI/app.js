...
submitBtn.addEventListener("click", (e) => {
  ...
  console.log(
    "🚀 ~ file: app.js:11 ~ submitBtn.addEventListener ~ order_date:",
    order_date
  );
  console.log(typeof order_date);
  const pickup_location = document.querySelector("#pickup_location").value;
  console.log(
    "🚀 ~ file: app.js:13 ~ submitBtn.addEventListener ~ pickup_location:",
    pickup_location
  );
  console.log(typeof pickup_location);
  const comment = document.querySelector("#comment").value;
  console.log(
    "🚀 ~ file: app.js:15 ~ submitBtn.addEventListener ~ comment:",
    comment
  );
  console.log(typeof comment);
  const billing_customer_name = document.querySelector(
    "#billing_customer_name"
  ).value;
  console.log(
    "🚀 ~ file: app.js:17 ~ submitBtn.addEventListener ~ billing_customer_name:",
    billing_customer_name
  );
  console.log(typeof billing_customer_name);
  const billing_last_name = document.querySelector("#billing_last_name").value;
  console.log(
    "🚀 ~ file: app.js:19 ~ submitBtn.addEventListener ~ billing_last_name:",
    billing_last_name
  );
  console.log(typeof billing_last_name);
  const billing_address = document.querySelector("#billing_address").value;
  console.log(
    "🚀 ~ file: app.js:21 ~ submitBtn.addEventListener ~ billing_address:",
    billing_address
  );
  ...
  console.log(
    "🚀 ~ file: app.js:44 ~ submitBtn.addEventListener ~ product_selling_price:",
  ...
  console.log(
    "🚀 ~ file: app.js:50 ~ submitBtn.addEventListener ~ channel_id:",
    channel_id
  );
  console.log(typeof channel_id);

  const shipping_customer_name = document.querySelector(
    "#shipping_customer_name"
  ).value;
  console.log(
    "🚀 ~ file: app.js:53 ~ submitBtn.addEventListener ~ shipping_customer_name:",
    shipping_customer_name
  );
  console.log(typeof shipping_customer_name);

  const shipping_last_name = document.querySelector(
    "#shipping_last_name"
  ).value;
  console.log(
    "🚀 ~ file: app.js:56 ~ submitBtn.addEventListener ~ shipping_last_name:",
    shipping_last_name
  );
  ...
  console.log(
    "🚀 ~ file: app.js:59 ~ submitBtn.addEventListener ~ shipping_address:",
    shipping_address
  );
  console.log(typeof shipping_address);

  const shipping_address_2 = document.querySelector(
    "#shipping_address_2"
  ).value;
  console.log(
    "🚀 ~ file: app.js:62 ~ submitBtn.addEventListener ~ shipping_address_2:",
    shipping_address_2
  );
  ...
  console.log(
    "🚀 ~ file: app.js:65 ~ submitBtn.addEventListener ~ shipping_city:",
    shipping_city
  );
  ...
  console.log(
    "🚀 ~ file: app.js:68 ~ submitBtn.addEventListener ~ shipping_pincode:",
    shipping_pincode
  );
  ...
  console.log(
    "🚀 ~ file: app.js:71 ~ submitBtn.addEventListener ~ shipping_state:",
    shipping_state
  );
  ...
  console.log(
    "🚀 ~ file: app.js:74 ~ submitBtn.addEventListener ~ shipping_country:",
    shipping_country
  );
  ...
  console.log(
    "🚀 ~ file: app.js:77 ~ submitBtn.addEventListener ~ shipping_email:",
    shipping_email
  );
  ...
  console.log(
    "🚀 ~ file: app.js:80 ~ submitBtn.addEventListener ~ shipping_phone:",
    shipping_phone
  );
  ...
  console.log(
    "🚀 ~ file: app.js:89 ~ submitBtn.addEventListener ~ payment_method:",
    payment_method
  );
  ...
  console.log(
    "🚀 ~ file: app.js:95 ~ submitBtn.addEventListener ~ giftwrap_charges:",
    giftwrap_charges
  );
  console.log(typeof giftwrap_charges);

  const transaction_charges = +document.querySelector("#transaction_charges")
    .value; // Transaction charges is an integer
  console.log(
    "🚀 ~ file: app.js:98 ~ submitBtn.addEventListener ~ transaction_charges:",
    transaction_charges
  );
  ...
  console.log(
    "🚀 ~ file: app.js:101 ~ submitBtn.addEventListener ~ total_discount:",
    total_discount
  );
  ...
  console.log(
    "🚀 ~ file: app.js:104 ~ submitBtn.addEventListener ~ sub_total:",
    sub_total
  );
  ...
  console.log(
    "🚀 ~ file: app.js:107 ~ submitBtn.addEventListener ~ length:",
    length
  );
  ...
  console.log(
    "🚀 ~ file: app.js:110 ~ submitBtn.addEventListener ~ breadth:",
    breadth
  );
  ...
  console.log(
    "🚀 ~ file: app.js:113 ~ submitBtn.addEventListener ~ height:",
    height
  );
  ...
  console.log(
    "🚀 ~ file: app.js:116 ~ submitBtn.addEventListener ~ weight:",
    weight
  );
  ...
  xhr.addEventListener("readystatechange", function () {
    // EL for state change when readystate changes readystatechange fires
...
getBtn.addEventListener("click", (e) => {
  ...
  xhr.open(
    "GET",
    "https://apiv2.shiprocket.in/v1/external/orders?order_id=362757350"
  );
  xhr.setRequestHeader("Content-Type", "application/json");
  xhr.setRequestHeader(
    "Authorization",
    "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjM2NjI1NDcsImlzcyI6Imh0dHBzOi8vYXBpdjIuc2hpcHJvY2tldC5pbi92MS9leHRlcm5hbC9hdXRoL2xvZ2luIiwiaWF0IjoxNjg2OTAwMDk1LCJleHAiOjE2ODc3NjQwOTUsIm5iZiI6MTY4NjkwMDA5NSwianRpIjoiUWY0NWN2SHRZTjdhR09odiJ9.Z2r4WIDrGJD3vJJsuUUYVUmadX9J8Drb9KbMMQpRbqU"
  );
  xhr.send();
});

//Generate AWB POST Request
const generateAwbBtn = document.querySelector("#submitAwbServiceIdBtn");

generateAwbBtn.addEventListener("click", (e) => {
  e.preventDefault();
  const shipment_id = document.querySelector("#shipment_id").value;
  const shipping_service = document.querySelector("#shipping_service").value;
  ...
  var requestOptions = {
    ...
    headers: myHeaders,
    body: raw,
    redirect: "follow", // Follows the redirect mode of the request
  };
...
const getOrderDetailsBtn = document.querySelector("#getOrderDetailsBtn");
getOrderDetailsBtn.addEventListener("click", (e) => {
  e.preventDefault();
  var order_getter_id = document.querySelector("#order_details_id").value;
  ...
  fetch(
    `https://apiv2.shiprocket.in/v1/external/orders/show/${order_getter_id}`,
    requestOptions
  )
    .then((response) => response.text())
    .then((result) => console.log(result))
...
const getAllOrderDetailsBtn = document.querySelector("#getAllOrderDetailsBtn");
getAllOrderDetailsBtn.addEventListener("click", (e) => {
  e.preventDefault();
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  // myHeaders.append("order_id", "362757350");
  myHeaders.append(
    "Authorization",
    "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..FCnhW4r16896wUmoh8aBtlPvOchfkSgAKkstS8Prww0"
  );
